...
public class LuogoPage extends JFrame {
    private JTable fotoTable;
    Controller gallerycontroller = new Controller();
    public LuogoPage (Luogo luogo) throws SQLException {
        setTitle(luogo.getNome());
        setSize(600, 400);
        ...
        JLabel title = new JLabel(luogo.getNome());
        ...
        loadPhotos(model, luogo.getIdLuogo());
    ...
    private void loadPhotos(DefaultTableModel model, int idluogo) throws SQLException {
        ArrayList<Foto> albumFoto = gallerycontroller.getLuogoFoto(idluogo);
